    ...
    <Layout user={user} setUser={setUser}>
      <div className="space-y-6" data-testid="dashboard-page">
        ...
        {showPerformanceModal && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999] p-4" onClick={() => setShowPerformanceModal(false)}>
            <div className="bg-white rounded-2xl p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto relative z-[10000]" onClick={(e) => e.stopPropagation()}>
