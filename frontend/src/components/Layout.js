...
const Layout = ({ children, user, setUser }) => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="layout-container">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-[#E50019] text-white z-[9999] transform transition-transform duration-300 lg:translate-x-0 flex flex-col ${
        ...
        <div className="p-6 pb-4">
          <div className="flex flex-col items-center justify-center gap-2">
            <img 
              ...
              className="h-32"
            />
            <h1 className="text-lg font-bold text-white text-center leading-tight">PediZone İş Takip Sistemi</h1>
          </div>
        </div>
